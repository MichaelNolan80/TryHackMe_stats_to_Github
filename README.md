...
|---|---|---|
| [Edition 1 — Basic Copy and Paste](editions/basic-copy-paste.md) | First working version using screenshot capture and fixed cropping | Complete / tested |
| [Edition 2 — Banner Detection and Selected Area Capture](editions/banner-selected-area.md) | Planned improvement to close banners and capture a selected stats section | Planned |
